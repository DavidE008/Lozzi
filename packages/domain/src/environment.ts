...
export const parseEnvironment = (
  ...
  return {
    ...
    capabilities: [
      ...
      optionalState(Boolean(env.NEXT_PUBLIC_WORLD_APP_ID), "world", "World verification"),
      optionalState(Boolean(env.WORLD_CHAIN_RPC_URL), "world-chain", "World Chain Sepolia"),
      optionalState(Boolean(env.NEXT_PUBLIC_ENS_PARENT), "ens", "ENS subnames"),
      optionalState(Boolean(env.ZERO_G_ROUTER_URL), "zero-g", "0G Compute Router"),
      optionalState(
