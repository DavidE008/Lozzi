      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_20rem]">
        <Card className="shadow-none">
          ...
          <CardContent>
            ...
            <div className="bg-border mt-8 grid gap-px overflow-hidden rounded-sm border sm:grid-cols-2">
              <div className="bg-card p-5">
                <p className="text-muted-foreground text-xs tracking-wider uppercase">
                  Completed
                </p>
                <p className="font-heading mt-2 text-2xl font-semibold">
                  {dashboard.creditsEarned} credits
                </p>
              </div>
              <div className="bg-card p-5">
                <p className="text-muted-foreground text-xs tracking-wider uppercase">
        ...
        <Card className="border-lozzi-gold/30 bg-lozzi-gold/5 h-fit shadow-none">
          <CardHeader>
