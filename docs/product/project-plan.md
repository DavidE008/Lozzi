...
Implementation uses small commits on `codex/milestones-0-1`. A gate is complete
only when its executable checks pass; documentation never substitutes for a
failing control.
